...
<div class="form-row" style="border-bottom:1px solid #ccc">
	...
	<div class="form-group col" align="center">
		<h3 style="margin-top: 14%;">Informe de Amortización</h3>
	</div>
...
<thead>
  <th style="white-space: nowrap;">No. Cuota</th>
  <th style="white-space: nowrap;">Fecha Pago</th>
  <th style="white-space: nowrap;">Balance</th>
  <th style="white-space: nowrap;">Abono Capital</th>
  <th style="white-space: nowrap;">Interés</th>
  <th style="white-space: nowrap;">Monto Pagar</th>
...
?>
    <tr>
      ...
      <td style="white-space: nowrap;"><?php print("RD$ ".number_format($row->balance,'2')); ?></td>
      <td style="white-space: nowrap;"><?php print("RD$ ".number_format($row->abono_capital,'2')); ?></td>
      <td style="white-space: nowrap;"><?php print("RD$ ".number_format($row->interes,'2')); ?></td>
      <td style="white-space: nowrap;"><?php print("RD$ ".number_format($row->monto_pagar,'2')); ?></td>
...
<?php } 
        ...
        echo "<tr>";
        echo "<td colspan='7' class='py-5' style='font-size:20px;' align='center'>No hay Pagos Realizados</td>";
        echo "</tr>";
}?>     
  </tbody>
</table>
