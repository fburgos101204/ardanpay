...
if ($negocio == 0 || isset($_POST['location'])) {
...
<button type="button" style="float: right;" class="btn btn-light btn-mdax" data-toggle="modal" data-target="#User" onclick="newCbUser('<?php echo $negocio; ?>')"  title="Agregar Usuario">Nuevo</button>

<!--button type="button" style="float: right;" class="btn btn-primary" data-toggle="modal" data-target="#User" onclick="newCbUser('<?php echo $negocio; ?>')">Nuevo</button-->
</div>
<div class="card-body">
...
?>
    <tr>
	    <td style="white-space: nowrap;">Xilus Financiera</td>
